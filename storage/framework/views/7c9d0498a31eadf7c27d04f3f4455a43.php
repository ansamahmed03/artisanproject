...
<div class="section" style="background:#fff;">
    ...
    <div class="cats-grid">
        ...
        <a href="#" class="cat-card">
            ...
            <div class="cat-count"><?php echo e($cat->products_count ?? '0'); ?> items</div>
        </a>
...
<a href="<?php echo e(route('front.products')); ?>" class="see-all">See all →</a>    </div>
    <div class="products-grid">
        <?php $__currentLoopData = $featuredProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  <div class="prod-card" onclick="window.location='<?php echo e(route('front.product.show', $product->id)); ?>'" style="cursor:pointer;">
         <div class="prod-img">
    <?php if($product->images && $product->images->first()): ?>
        <img src="<?php echo e(asset('storage/' . $product->images->first()->image_path)); ?>"
             alt="<?php echo e($product->name); ?>" style="width:100%;height:100%;object-fit:cover;">
    <?php else: ?>
    ...
    <?php endif; ?>
            ...
            <div class="prod-body">
                ...
                <div class="prod-artisan">by <?php echo e($product->artisan->name ?? ''); ?></div>
                <div class="prod-footer">
                    <span class="prod-price">$<?php echo e($product->price); ?></span>
...
<?php echo $__env->make('frontend.layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/artisanproject/resources/views/frontend/home.blade.php ENDPATH**/ ?>