...
<head>
    ...
    <title>ArtisanHub - <?php echo $__env->yieldContent('title', 'Handcrafted Treasures'); ?></title>
...
<nav class="navbar">
    <a href="<?php echo e(route('front.home')); ?>" class="nav-logo">Artisan<span>Hub</span></a>
    <div class="nav-links">
...
<?php /**PATH /home/artisanproject/resources/views/frontend/layout/app.blade.php ENDPATH**/ ?>