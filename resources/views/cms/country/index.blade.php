...
@section('main-title' , 'main-Country')
@section('sub-title', 'sub-Country')
@section('title', 'title')
                ...
                <table class="table table-bordered">
                  ...
                  @foreach($countries as $country)
                    <tr>
                      ...
                      <td>
                             <div class="btn-group">
                            <a href="{{ route('countries.show' , $country->id ) }}" class="btn btn-info" title="show">
                           ...
                           <button type="button" onclick="performDestroy({{ $country->id  }},this)" class="btn btn-danger" title="delte">
